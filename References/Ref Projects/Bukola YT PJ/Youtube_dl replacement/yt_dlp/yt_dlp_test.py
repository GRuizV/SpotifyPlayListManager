...
YT_DLP_JSON_PATH = r'C:\Users\USUARIO\GR\Software Development\Projects\Spotify Playlists Manager\References\Ref Projects\Bukola YT PJ\Youtube_dl replacement\yt_dlp\yt_dlp_response.json'
...
class CreatePlaylist:
    ...
    def get_liked_videos(youtube_client:googleapiclient.discovery.build) -> dict:
            ...
            for item in response["items"]:
                ...
                all_song_info[video_title] = video

            with open(YT_DLP_JSON_PATH, 'w') as f:
